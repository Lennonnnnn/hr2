...
$sql = "SELECT e_id, firstname, lastname, department, role, position FROM employee_register WHERE role = 'employee' AND department = 'Marketing Department'";
...
<body class="bg-secondary">
    <h2 class="text-light">Marketing Department Employee Evaluation</h2>
        <div class="container">
