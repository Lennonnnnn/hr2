                        ...
                        <tr class="text-center text-light">
                            ...
                            <td>
                                <button class="btn btn-success btn-sm" 
                                        onclick="fillUpdateForm(<?php echo $row['a_id']; ?>, '<?php echo addslashes(htmlspecialchars($row['firstname'])); ?>', '<?php echo addslashes(htmlspecialchars($row['lastname'])); ?>', '<?php echo addslashes(htmlspecialchars($row['email'])); ?>', '<?php echo addslashes(htmlspecialchars($row['role'])); ?>', '<?php echo addslashes(htmlspecialchars($row['phone_number'])); ?>', '<?php echo addslashes(htmlspecialchars($row['address'])); ?>')">Update</button>
